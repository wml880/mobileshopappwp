...
public class NavingationFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void select(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.ib_category:
                ...
                }else {fragmentTransaction.show(categroyFragment);}
                break;
            case R.id.ib_cart:
            ...
            case R.id.ib_personal:
                ...
                }else {fragmentTransaction.show(personalFragment);}
                break;
        }
